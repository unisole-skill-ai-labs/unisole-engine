...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_projects_dept" ON "projects" USING btree ("department_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sub_projects_project" ON "sub_projects" USING btree ("project_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "idx_sub_projects_status" ON "sub_projects" USING btree ("status");
--> statement-breakpoint
