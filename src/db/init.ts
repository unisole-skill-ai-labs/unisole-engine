...
export async function initializeDatabase() {
  try {
    ...
    await execSqlSafe("seed_foundational_courses", `
      ...
      VALUES 
        ('cs-genai', 'Generative AI & LLM Systems Engineering', 'cs-genai', 'Master enterprise-grade LLM architectures, production RAG pipelines, vector databases (Qdrant), PEFT/LoRA fine-tuning, and high-throughput vLLM serving.', 299900, 999900, 'PUBLISHED'::content_status, '{"group": "group-1", "pathwayId": "cs-genai", "badge": "GROUP 01 • PATHWAY 01", "shortName": "CS & IT: Generative AI"}'::jsonb, TRUE),
        ('cs-agentic', 'Agentic AI & Autonomous Multi-Agent Systems', 'cs-agentic', 'Design and deploy autonomous AI agents with reasoning loops, dynamic tool calling, stateful graphs in LangGraph, multi-agent swarms with CrewAI, and Model Context Protocol (MCP).', 299900, 999900, 'PUBLISHED'::content_status, '{"group": "group-1", "pathwayId": "cs-agentic", "badge": "GROUP 01 • PATHWAY 02", "shortName": "CS & IT: Agentic AI"}'::jsonb, TRUE),
        ('cs-p1', 'Machine Learning Engineering in Production', 'cs-p1', 'End-to-end ML engineering: data pipelines, deep learning, FastAPI model serving, Docker MLOps, and Generative AI/RAG architectures.', 299900, 999900, 'PUBLISHED'::content_status, '{"group": "group-1", "pathwayId": "cs-p1", "badge": "GROUP 01 • PATHWAY 03", "shortName": "CS & IT: ML Engineering"}'::jsonb, TRUE),
